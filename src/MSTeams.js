...
const statuses = [{
  ...
  activityImage: 'https://raw.githubusercontent.com/teampurpose/notify-microsoft-teams/master/icons/success.png'
  ...
  activitySubtitle: head_commit.timestamp,
  activityImage: 'https://raw.githubusercontent.com/teampurpose/notify-microsoft-teams/master/icons/failure.png'
  ...
  activitySubtitle: head_commit.timestamp,
  activityImage: 'https://raw.githubusercontent.com/teampurpose/notify-microsoft-teams/master/icons/cancelled.png'
}, {
  id: 'skipped',
  icon: '⤼',
  activityTitle: 'Skipped',
  activitySubtitle: head_commit.timestamp,
  activityImage: 'https://raw.githubusercontent.com/teampurpose/notify-microsoft-teams/master/icons/skipped.png'
}, {
  id: 'unknown',
  icon: '?',
  activityTitle: 'No job context has been provided',
  activitySubtitle: head_commit.timestamp,
  activityImage: 'https://raw.githubusercontent.com/teampurpose/notify-microsoft-teams/master/icons/unknown.png'
}];
...
class MSTeams {
   ...
   * @param repo_link {string} link for repository
   * @return
   */
